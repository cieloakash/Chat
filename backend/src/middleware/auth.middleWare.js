...
export const validateSignup=[
  body("fullname").matches(/^[a-zA-Z\s]+$/).withMessage("Full name must only contain letters and spaces"),
  body("email").matches(/^[\w.-]+@[a-zA-Z\d.-]+\.[a-zA-Z]{2,}$/).withMessage("Invalid email format"),
